...
class Config(object):
  ...
  UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001796299442")
...
**This is New Movies and Series File Share Bot
To get Instant Updates Please Join Our Main Channel ♥️**"""
